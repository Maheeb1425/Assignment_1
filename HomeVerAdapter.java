    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView bottomImg = sheetView.findViewById(R.id.Bdetailed_img);
                TextView bottomName = sheetView.findViewById(R.id.Bdetailed_name);
                TextView bottomPrice = sheetView.findViewById(R.id.Bdetailed_price);
                TextView bottomRating = sheetView.findViewById(R.id.Bdetailed_rating);

                bottomImg.setImageResource(mImage);
                bottomName.setText(mName);
                bottomPrice.setText(mRating);
                bottomRating.setText(mPrice);
